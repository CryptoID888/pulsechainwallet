...
export const P = BigNumber.from('21888242871839275222246405745257275088548364400416034343698204186575808495617')

export function hashMod(types: string[], values: unknown[]): BigNumber {
