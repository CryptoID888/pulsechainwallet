...
import type { IncrementalMerkleTree, IncrementalMerkleTreeInterface } from '../../contracts/IncrementalMerkleTree'
...
type IncrementalMerkleTreeConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>

const isSuperArgs = (xs: IncrementalMerkleTreeConstructorParams): xs is ConstructorParameters<typeof ContractFactory> =>
  xs.length > 1
...
export class IncrementalMerkleTree__factory extends ContractFactory {
  ...
  override deploy(poseidon: AddressLike, overrides?: NonPayableOverrides & { from?: string }) {
  ...
  override connect(runner: ContractRunner | null): IncrementalMerkleTree__factory {
  ...
  static connect(address: string, runner?: ContractRunner | null): IncrementalMerkleTree {
    return new Contract(address, _abi, runner) as unknown as IncrementalMerkleTree
  }
}
