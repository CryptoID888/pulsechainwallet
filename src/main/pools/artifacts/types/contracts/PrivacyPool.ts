...
export declare namespace PrivacyPool {
  ...
  export type WithdrawalRequestStructOutput = [proof: PrivacyPool.WithdrawalProofStructOutput, feeReceiver: string] & {
...
export interface PrivacyPoolInterface extends Interface {
  ...
  encodeFunctionData(functionFragment: 'assetMetadata', values?: undefined): string
  ...
  encodeFunctionData(functionFragment: 'depositMany', values: [BytesLike[]]): string
  ...
  encodeFunctionData(functionFragment: 'nullifiers', values: [BytesLike]): string
  encodeFunctionData(functionFragment: 'roots', values: [BigNumberish]): string
  encodeFunctionData(functionFragment: 'verifyWithdrawal', values: [PrivacyPool.WithdrawalProofStruct]): string
  encodeFunctionData(functionFragment: 'withdraw', values: [PrivacyPool.WithdrawalRequestStruct]): string
  ...
  decodeFunctionResult(functionFragment: 'assetMetadata', data: BytesLike): Result
  ...
  decodeFunctionResult(functionFragment: 'depositMany', data: BytesLike): Result
  ...
  decodeFunctionResult(functionFragment: 'verifyWithdrawal', data: BytesLike): Result
...
export namespace DepositEvent {
  ...
  export type OutputTuple = [commitment: string, leaf: string, asset: string, denomination: bigint, leafIndex: bigint]
...
export namespace WithdrawalEvent {
  ...
  export type OutputTuple = [recipient: string, relayer: string, subsetRoot: string, nullifier: string, fee: bigint]
  export interface OutputObject {
    recipient: string
    relayer: string
    subsetRoot: string
...
export interface PrivacyPool extends BaseContract {
  ...
  depositMany: TypedContractMethod<[inputs: BytesLike[]], [bigint[]], 'payable'>
  ...
  verifyWithdrawal: TypedContractMethod<[proof: PrivacyPool.WithdrawalProofStruct], [void], 'view'>

  withdraw: TypedContractMethod<[withdrawRequest: PrivacyPool.WithdrawalRequestStruct], [void], 'payable'>
  ...
  getFunction(nameOrSignature: 'assetMetadata'): TypedContractMethod<[], [string], 'view'>
  ...
  getFunction(nameOrSignature: 'deposit'): TypedContractMethod<[commitment: BytesLike], [bigint], 'payable'>
  getFunction(nameOrSignature: 'depositMany'): TypedContractMethod<[inputs: BytesLike[]], [bigint[]], 'payable'>
  ...
  getFunction(nameOrSignature: 'nullifiers'): TypedContractMethod<[arg0: BytesLike], [boolean], 'view'>
  getFunction(nameOrSignature: 'roots'): TypedContractMethod<[arg0: BigNumberish], [string], 'view'>
  getFunction(
    nameOrSignature: 'verifyWithdrawal',
  ): TypedContractMethod<[proof: PrivacyPool.WithdrawalProofStruct], [void], 'view'>
  getFunction(
    nameOrSignature: 'withdraw',
  ): TypedContractMethod<[withdrawRequest: PrivacyPool.WithdrawalRequestStruct], [void], 'payable'>
  ...
  getEvent(
    key: 'Withdrawal',
  ): TypedContractEvent<WithdrawalEvent.InputTuple, WithdrawalEvent.OutputTuple, WithdrawalEvent.OutputObject>
