...
const parseBigIntArray = (o: string[]) => o.map((o: string) => BigInt(o))

const parseNestedBigIntArray = (o: string[][]) => o.map(parseBigIntArray)

// Parameters are generated by a reference script https://extgit.iaik.tugraz.at/krypto/hadeshash/-/blob/master/code/generate_parameters_grain.sage
// Used like so: sage generate_parameters_grain.sage 1 0 254 2 8 56 0x30644e72e131a029b85045b68181585d2833e84879b9709143e1f593f0000001
import constants from './poseidon_constants_opt.json'
const opt = {
  C: parseNestedBigIntArray(constants.C),
  M: constants.M.map(parseNestedBigIntArray),
  P: constants.P.map(parseNestedBigIntArray),
  S: parseNestedBigIntArray(constants.S),
}
